...
let productoriginalpriceshow = document.querySelector(
  ".price-of-product-show-old"
);
const containerX = document.querySelector(".containerX");
let wrapper_container_of_show = document.querySelector(
  ".wrapper-of-two-container"
);
